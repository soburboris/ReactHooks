...
const Comments = ( {fetchArticleResponseComments, doFetchComments, apiURL,isSuccessfull, setIsSuccesfull,setBody}) => {
   
    return (
        <div>
            {fetchArticleResponseComments.comments.map((comments,id) =>{
